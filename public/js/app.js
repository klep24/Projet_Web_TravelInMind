...
jQuery(document).ready(function(){
  ...
  $("#valid_register").on("click", function() {
  document.location.href=("modifInfos.php?prenom="+$("#user_firstname").val()+"&"+
        "nom="+$("#user_lastname").val()+"&"+
        "mail="+$("#user_mail").val()+"&"+
        "password="+$("#user_password").val()+"&"+
        "phone="+$("#user_phone").val()+"&"+
        "station_id="+gare_dep.id+"&"+
        "station_name="+gare_dep.value+"&");
  });



  $("#valid_modif").on("click", function() {
        document.location.href=("modifInfos.php?prenom="+$("#user_firstname").val()+"&"+
              "nom="+$("#user_lastname").val()+"&"+
              "mail="+$("#user_mail").val()+"&"+
              "password="+$("#user_password").val()+"&"+
